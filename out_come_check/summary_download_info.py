...
out_excel_file = "sentinel_1_download_info.xlsx"
...
for idx_city in range(len(cityname)):
    ...
    for tt in range(0,len(startDate)):
        ...
        if os.path.exists(outdatapath+'data_downloaded.ok'):
        ...
        if len(products)==0:
            ...
            info_city.append(404)
            continue


        print('----------------- '+city+' in '+startDate[tt][:6]+': data set was found, data to be downloaded ---------------------\n')
        info_city.append(0)
